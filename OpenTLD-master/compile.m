...
% Compiles mex files
clc; clear all; cd D:\Documents\MATLAB\OpenTLD-master\mex;

if ispc
    disp('PC');
    include = ' -ID:\ProgramFiles\opencv\build\include\ -ID:\ProgramFiles\opencv\build\include\opencv\ -ID:\ProgramFiles\opencv\build\include\opencv2\';
    libpath = 'D:\ProgramFiles\opencv\build\x86\vc12\lib';
